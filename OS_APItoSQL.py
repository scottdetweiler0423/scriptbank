...
account_list = ['NCAR_CAN', 'ICAR_CAN', 'NCAR_US', 'ICAR_US']
...
for account in account_list:
    ...
    # enter start and end dates here
    start_dates = ['2019-01-01', '2019-01-08','2019-01-16', '2019-01-22']

    end_dates = ['2019-01-07', '2019-01-15','2019-01-21', '2019-01-29']

    print('-----------------Pulling data from '+account+' for period: ' + start_dates[0] + ' to ' + end_dates[-1] + '----------------------')
